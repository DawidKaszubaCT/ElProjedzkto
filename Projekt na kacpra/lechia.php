...
$winrate = $conn->query("SELECT Winrate FROM kluby where IDK = 17");

$win = $conn->query("SELECT Wygrane FROM kluby WHERE IDK = 17");
$draw = $conn->query("SELECT Remisy FROM kluby WHERE IDK = 17");
$lose = $conn->query("SELECT Przegrane FROM kluby WHERE IDK = 17");
...
<body>
    <main>
        ...
        <section id="main-section">
            <div class="box"><img src="https://upload.wikimedia.org/wikipedia/en/thumb/b/b7/Lechia_Gda%C5%84sk_logo.svg/1200px-Lechia_Gda%C5%84sk_logo.svg.png" id="rakow_logo"></div>
            <div class="box_wdl">
                <p>
                    Wygrane: <?php
                         $row = $win->fetch_assoc();
