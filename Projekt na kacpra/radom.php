...
$winrate = $conn->query("SELECT Winrate FROM kluby where IDK = 12");

$win = $conn->query("SELECT Wygrane FROM kluby WHERE IDK = 12");
$draw = $conn->query("SELECT Remisy FROM kluby WHERE IDK = 12");
$lose = $conn->query("SELECT Przegrane FROM kluby WHERE IDK = 12");
...
<body>
    <main>
        ...
        <section id="main-section">
            <div class="box"><img src="https://upload.wikimedia.org/wikipedia/commons/2/2b/Herb_radomiaka_300dpi.png" id="rakow_logo"></div>
            <div class="box_wdl">
                <p>
                    Wygrane: <?php
                         $row = $win->fetch_assoc();
            ...
            <div id="numer">12</div></div>
            <div class="box" id="box">
            <h1 class="next_match">Poprzedni mecz</h1>
            <div id="content">
            <img src="https://mks-korona-kielce.pl/wp-content/uploads/2018/11/korona_png.png" id="minimg">
                Korona 1:3 Radomiak
                <img src="https://upload.wikimedia.org/wikipedia/commons/2/2b/Herb_radomiaka_300dpi.png" id="minimg">
            </div>
            </div>
            <div class="box" id="box">
