...
$winrate = $conn->query("SELECT Winrate FROM kluby where IDK = 3");

$win = $conn->query("SELECT Wygrane FROM kluby WHERE IDK = 3");
$draw = $conn->query("SELECT Remisy FROM kluby WHERE IDK = 3");
$lose = $conn->query("SELECT Przegrane FROM kluby WHERE IDK = 3");
...
<body>
    <main>
        ...
        <section id="main-section">
            <div class="box"><img src="https://upload.wikimedia.org/wikipedia/en/thumb/b/b0/KKS_Lech_Pozna%C5%84.svg/800px-KKS_Lech_Pozna%C5%84.svg.png" id="rakow_logo"></div>
            <div class="box_wdl">
                <p>
                    Wygrane: <?php
                         $row = $win->fetch_assoc();
