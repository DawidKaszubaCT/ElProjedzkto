...
$winrate = $conn->query("SELECT Winrate FROM kluby where IDK = 14");

$win = $conn->query("SELECT Wygrane FROM kluby WHERE IDK = 14");
$draw = $conn->query("SELECT Remisy FROM kluby WHERE IDK = 14");
$lose = $conn->query("SELECT Przegrane FROM kluby WHERE IDK = 14");
...
<body>
    <main>
        ...
        <section id="main-section">
            <div class="box"><img src="https://upload.wikimedia.org/wikipedia/en/thumb/a/a1/Puszcza_Niepolomice_Herb_Full.svg/1200px-Puszcza_Niepolomice_Herb_Full.svg.png" id="rakow_logo"></div>
            <div class="box_wdl">
                <p>
                    Wygrane: <?php
                         $row = $win->fetch_assoc();
            ...
            <div id="numer">14</div></div>
            <div class="box" id="box">
            <h1 class="next_match">Poprzedni mecz</h1>
            <div id="content">
                <img src="https://upload.wikimedia.org/wikipedia/en/thumb/a/a1/Puszcza_Niepolomice_Herb_Full.svg/1200px-Puszcza_Niepolomice_Herb_Full.svg.png" id="minimg">
                Puszcza 1:3 Cracovia
                <img src="https://upload.wikimedia.org/wikipedia/en/thumb/b/b9/Cracovia_%28football_club%29_logo.svg/1200px-Cracovia_%28football_club%29_logo.svg.png" id="minimg">
            </div>
            </div>
            <div class="box" id="box">
                ...
                <img src="https://upload.wikimedia.org/wikipedia/en/thumb/a/a1/Puszcza_Niepolomice_Herb_Full.svg/1200px-Puszcza_Niepolomice_Herb_Full.svg.png" id="minimg">
                    Puszcza - Pogon
                    <img src="https://upload.wikimedia.org/wikipedia/en/thumb/5/55/Pogon_Szczecin_logo.svg/1200px-Pogon_Szczecin_logo.svg.png" id="minimg">
