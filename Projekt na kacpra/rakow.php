...
$winrate = $conn->query("SELECT Winrate FROM kluby where IDK = 1");

$win = $conn->query("SELECT Wygrane FROM kluby WHERE IDK = 1");
$draw = $conn->query("SELECT Remisy FROM kluby WHERE IDK = 1");
$lose = $conn->query("SELECT Przegrane FROM kluby WHERE IDK = 1");
...
<body>
    <main>
        ...
        <section id="main-section">
            <div class="box"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Rks_rakow_crest_ai.svg/800px-Rks_rakow_crest_ai.svg.png" id="rakow_logo"></div>
            <div class="box_wdl">
                <p>
                    Wygrane: <?php
                         $row = $win->fetch_assoc();
            ...
            <div id="content">
                ...
                Raków 3:0 GKS Tychy
                <img src="https://upload.wikimedia.org/wikipedia/commons/0/0a/Gkstychy.png" id="minimg">
            </div>
            </div>
            <div class="box" id="box">
