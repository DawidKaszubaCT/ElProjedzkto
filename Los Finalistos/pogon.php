...
$winrate = $conn->query("SELECT Winrate FROM kluby where IDK = 4");

$win = $conn->query("SELECT Wygrane FROM kluby WHERE IDK = 4");
$draw = $conn->query("SELECT Remisy FROM kluby WHERE IDK = 4");
$lose = $conn->query("SELECT Przegrane FROM kluby WHERE IDK = 4");
...
<body>
    <main>
        ...
        <section id="main-section">
            <div class="box"><img src="https://upload.wikimedia.org/wikipedia/en/thumb/5/55/Pogon_Szczecin_logo.svg/1200px-Pogon_Szczecin_logo.svg.png" id="rakow_logo"></div>
            <div class="box_wdl">
                <p>
                    Wygrane: <?php
                         $row = $win->fetch_assoc();
            ...
            <div id="content">
                ...
                Pogon 0:0 Legia
                <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Legia_Warszawa.png" id="minimg">
            </div>
            </div>
            <div class="box" id="box">
