...
$winrate = $conn->query("SELECT Winrate FROM kluby where IDK = 16");

$win = $conn->query("SELECT Wygrane FROM kluby WHERE IDK = 16");
$draw = $conn->query("SELECT Remisy FROM kluby WHERE IDK = 16");
$lose = $conn->query("SELECT Przegrane FROM kluby WHERE IDK = 16");
...
<body>
    <main>
        ...
        <section id="main-section">
            <div class="box"><img src="https://upload.wikimedia.org/wikipedia/en/thumb/2/20/Zag%C5%82%C4%99bie_Lubin_crest.svg/1200px-Zag%C5%82%C4%99bie_Lubin_crest.svg.png" id="rakow_logo"></div>
            <div class="box_wdl">
                <p>
                    Wygrane: <?php
                         $row = $win->fetch_assoc();
            ...
            <div id="numer">16</div></div>
            <div class="box" id="box">
            <h1 class="next_match">Poprzedni mecz</h1>
            <div id="content">
                <img src="https://upload.wikimedia.org/wikipedia/en/thumb/2/20/Zag%C5%82%C4%99bie_Lubin_crest.svg/1200px-Zag%C5%82%C4%99bie_Lubin_crest.svg.png" id="minimg">
                Zaglebie 1:2 Chrobry Głogów
                <img src="https://upload.wikimedia.org/wikipedia/en/thumb/3/3f/Chrobry_G%C5%82og%C3%B3w_crest.svg/1200px-Chrobry_G%C5%82og%C3%B3w_crest.svg.png" id="minimg">
            </div>
            </div>
            <div class="box" id="box">
                <h1 class="next_match">Nastepny mecz</h1>
                <div id="content">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Rks_rakow_crest_ai.svg/800px-Rks_rakow_crest_ai.svg.png" id="minimg">
                    Raków - Zaglebie
