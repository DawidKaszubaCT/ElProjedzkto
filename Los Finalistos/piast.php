...
$winrate = $conn->query("SELECT Winrate FROM kluby where IDK = 10");

$win = $conn->query("SELECT Wygrane FROM kluby WHERE IDK = 10");
$draw = $conn->query("SELECT Remisy FROM kluby WHERE IDK = 10");
$lose = $conn->query("SELECT Przegrane FROM kluby WHERE IDK = 10");
...
<body>
    <main>
        ...
        <section id="main-section">
            <div class="box"><img src="https://upload.wikimedia.org/wikipedia/en/thumb/f/f6/GKS_Piast_Gliwice.svg/1200px-GKS_Piast_Gliwice.svg.png" id="rakow_logo"></div>
            <div class="box_wdl">
                <p>
                    Wygrane: <?php
                         $row = $win->fetch_assoc();
            ...
            <div id="numer">10</div></div>
            <div class="box" id="box">
            <h1 class="next_match">Poprzedni mecz</h1>
            <div id="content">
                <img src="https://upload.wikimedia.org/wikipedia/en/thumb/f/f6/GKS_Piast_Gliwice.svg/1200px-GKS_Piast_Gliwice.svg.png" id="minimg">
                Piast 0:2 Widzew
