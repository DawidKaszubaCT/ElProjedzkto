...
$winrate = $conn->query("SELECT Winrate FROM kluby where IDK = 11");

$win = $conn->query("SELECT Wygrane FROM kluby WHERE IDK = 11");
$draw = $conn->query("SELECT Remisy FROM kluby WHERE IDK = 11");
$lose = $conn->query("SELECT Przegrane FROM kluby WHERE IDK = 11");
...
<body>
    <main>
        ...
        <section id="main-section">
            <div class="box"><img src="https://mks-korona-kielce.pl/wp-content/uploads/2018/11/korona_png.png" id="rakow_logo"></div>
            <div class="box_wdl">
                <p>
                    Wygrane: <?php
                         $row = $win->fetch_assoc();
            ...
            <div class="box" id="box">
                ...
                <div id="content">
                    ...
                    <img src="https://upload.wikimedia.org/wikipedia/en/thumb/b/b0/KKS_Lech_Pozna%C5%84.svg/800px-KKS_Lech_Pozna%C5%84.svg.png" id="minimg">
                </div>
                <p>05.04.25 20:15</p>   
            </div>
