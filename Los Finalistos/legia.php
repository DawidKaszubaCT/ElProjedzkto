...
$winrate = $conn->query("SELECT Winrate FROM kluby where IDK = 5");

$win = $conn->query("SELECT Wygrane FROM kluby WHERE IDK = 5");
$draw = $conn->query("SELECT Remisy FROM kluby WHERE IDK = 5");
$lose = $conn->query("SELECT Przegrane FROM kluby WHERE IDK = 5");
...
<body>
    <main>
        ...
        <section id="main-section">
            <div class="box"><img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Legia_Warszawa.png" id="rakow_logo"></div>
            <div class="box_wdl">
                <p>
                    Wygrane: <?php
                         $row = $win->fetch_assoc();
            ...
            <div class="box" id="box">
                ...
                <div id="content">
                    ...
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Ruch_Chorz%C3%B3w_-_Herb_%282021%29.svg/1200px-Ruch_Chorz%C3%B3w_-_Herb_%282021%29.svg.png" id="minimg">
                </div>
                <p>02.04.25 18:00</p>   
            </div>
